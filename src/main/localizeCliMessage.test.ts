...
test('localizeCliMessage translates the known OpenCode blocked launch error for zh locale', () => {
...
test('localizeCliMessage translates the known OpenCode readiness reason for zh locale', () => {
...
test('localizeCliMessage leaves unrelated messages unchanged', () => {
